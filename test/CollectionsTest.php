...
class UnderscoreCollectionsTest extends PHPUnit_Framework_TestCase {
  ...
  public function testPluck() {
    ...
    $this->assertEquals($expected, __::pluck($stooges, ['name', 'age']));
  ...
  public function testSortBy() {
    ...
    $this->assertEquals($stooges, __::sortBy($stooges, 'age'));

    $st_obj = __::map($stooges, function ($stooge) { return (object) $stooge; });
    $this->assertEquals($st_obj, __::sortBy($st_obj, 'age'));
